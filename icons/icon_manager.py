...
class IconManager:
    ...
    def load_mime_types(self, path="/etc/mime.types"):
        """
        De mime.types, lee línea a línea y devuelve un diccionario key = extension.
        """
        ext_to_mime = {}
    ...
    def get_icon_name_for_mime(self, mime_type):
        # Gio devuelve un ThemedIcon o similar
        """
        Devuelve un Gio.ThemeIcon según su mime_type (una lista de posibles nombres)
        """
    ...
    def get_icon_for_file(self, filepath):
        """
        Devuelve un paintable según el tipo de mime obtenido de ext. Si no hay, del tipo text/plain
        """
